...
import { idlFactory } from './demo.did.js';
export { idlFactory } from './demo.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.DEMO_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./demo.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the demo canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./demo.did.js")._SERVICE>}
 */
export const demo = createActor(canisterId);
