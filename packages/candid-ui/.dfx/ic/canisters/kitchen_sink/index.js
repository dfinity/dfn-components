...
import { idlFactory } from './kitchen_sink.did.js';
export { idlFactory } from './kitchen_sink.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.KITCHEN_SINK_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./kitchen_sink.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the kitchen_sink canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./kitchen_sink.did.js")._SERVICE>}
 */
export const kitchen_sink = createActor(canisterId);
